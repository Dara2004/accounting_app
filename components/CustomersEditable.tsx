...
export function makeTableItem(curr: CustomerFromQuery): Item {
  return {
...
export type CustomerFromQuery = { __typename?: "Customer" } & Pick<
  Customer,
  "customerId" | "dealerId" | "address" | "name" | "phone" | "note" | "regionId"
> & {
    dealerByDealerId?: Maybe<{ __typename?: "Dealer" } & Pick<Dealer, "name">>;
  };
...
const EditableTable = ({
  ...
  customersData: GetCustomersQuery;
  dealersAndRegionsData: GetDealersAndRegionsQuery;
}) => {
  const [deleteCustomerByCustomerId, mutation] = useDeleteCustomerMutation();
  // const [
  //   updateCustomerByCustomerId,
  //   updateCustomerMutation,
  // ] = useUpdateCustomerMutation();
  const customers = customersData.allCustomers.nodes;
